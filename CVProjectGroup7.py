...
processedDir = "InterimResults/"
imterimDir = "InterimResults/"
...
for file in png_files:
    ...
    save_file = os.path.join(processedDir, os.path.basename(file).replace(".jpg", "").replace("image", "Image") + "_A_WeldGapPosition.jpg")
    imterim_file = os.path.join(processedDir, os.path.basename(file).replace(".jpg", "").replace("image", "Image")+ "_B_InterimResult1.jpg")
    print(imterim_file)
